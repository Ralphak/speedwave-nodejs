...
--
-- Host: localhost:3306
-- Tempo de geração: 13/12/2018 às 16:29
...
--
ALTER TABLE `bancoempbarco`
  MODIFY `id_bancoempbarco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `bancovendemp`
--
ALTER TABLE `bancovendemp`
  MODIFY `id_bancovendemp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `embarcacao`
--
ALTER TABLE `embarcacao`
  MODIFY `id_embarcacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `fotoembar`
  MODIFY `id_fotoembar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `vendemp`
  MODIFY `id_vendemp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `bancoempbarco`
  ADD CONSTRAINT `fk_bancoempbarco` FOREIGN KEY (`fk_empresa`) REFERENCES `empresabarco` (`id_empresa`) ON DELETE CASCADE ON UPDATE CASCADE;
